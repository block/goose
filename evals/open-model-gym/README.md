...
- `goose` — [Goose](https://github.com/bfg-ent/goose) agent framework
...
[Goose](https://github.com/bfg-ent/goose) is an open-source coding agent with built-in MCP support.
