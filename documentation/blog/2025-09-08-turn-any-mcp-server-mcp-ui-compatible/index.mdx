...
And if you zoom out, you’ll see other companies pushing here too. Goose and Postman already support rendering and partial UI actions.

And the fact that rendering works means we can start perfecting these UI experiences.
