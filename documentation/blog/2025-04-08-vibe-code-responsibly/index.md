...
[Goose](https://aaif-goose.github.io/goose) is an open source AI agent local to your machine with built-in features for safe vibe coding.  
...
Goose supports [`.gooseignore`](https://aaif-goose.github.io/goose/docs/guides/using-gooseignore) files. The concept is similar to `.gitignore` files for your AI agent. It defines which files and folders Goose should *not* read, modify, or interact with.
...
Goose's [`/plan`](https://aaif-goose.github.io/goose/docs/guides/goose-cli-commands#examples) command helps you align with your agent before any code is touched, giving you a clear understanding of what it intends to do and how it will do it.
...
Lower-performing models might work, but they're more likely to hallucinate or misunderstand your goals. Read more about how [different LLM's perform with Goose](https://aaif-goose.github.io/goose/blog/2025/03/31/goose-benchmark/).  
...
Download [Goose](https://aaif-goose.github.io/goose/docs/getting-started/installation/), and start vibe coding with intention today!

<head>
  <meta property="og:title" content="How to Vibe Code Responsibly (with Goose)" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://aaif-goose.github.io/goose/blog/2025/04/08/vibe-code-responsibly" />
  ...
  <meta property="og:image" content="http://aaif-goose.github.io/goose/assets/images/responsible-vibe-code-a77f5e24a879edda943cc76f1fc0bd2a.png" />
  ...
  <meta name="twitter:image" content="http://aaif-goose.github.io/goose/assets/images/responsible-vibe-code-a77f5e24a879edda943cc76f1fc0bd2a.png" />
</head>