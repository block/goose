...
<div style={{ width: '100%', maxWidth: '800px', margin: '0 auto' }}>
  <iframe
    width="100%"
    height="400"
    src="https://www.youtube.com/embed/xZo3aA-vFi4"
...
As my manager Angie Jones says, Claude Sonnet 4 was "born to code." I chose it because its capabilities help Goose resolve mistakes faster and think ahead.
...
<div style={{ width: '100%', maxWidth: '800px', margin: '0 auto' }}>
  <video 
    ...
    playsInline
  >
    <source src={require('@site/static/videos/emotion_detector_app.mov').default} type="video/mp4" />
