...
Curious how other models stack up? Check out the [Community-Inspired Benchmark Leaderboard](https://aaif-goose.github.io/goose/blog/2025/03/31/goose-benchmark/#leaderboard) to see how your favorite model performs with Goose.

And if you’re still deciding, here’s the full list of [available LLM providers](https://aaif-goose.github.io/goose/docs/getting-started/providers#available-providers).
...
To help you manage this, there is a [Handling Rate Limits Guide](https://aaif-goose.github.io/goose/docs/guides/handling-llm-rate-limits-with-goose/) that you can check out. 
...
You’ll find those livestreams on our [YouTube channel](https://www.youtube.com/@goose-oss/streams), and upcoming ones on the Discord calendar. Plus, if you prefer documentation, the [Goose docs](https://aaif-goose.github.io/goose/) and [blog](https://aaif-goose.github.io/goose/blog) are constantly being updated with new guides, tips, and tutorials.
...
Now, head over to the [Quickstart Guide](https://aaif-goose.github.io/goose/docs/quickstart) and get started.  

Oh and when you get to the [Tic-Tac-Toe game](https://aaif-goose.github.io/goose/docs/quickstart/#write-prompt), I’ll bet you 10 Goosebucks you won’t beat the bot. 
...
<head>
  ...
  <meta property="og:url" content="https://aaif-goose.github.io/goose/blog/2025/04/23/things-need-to-know" />
  ...
  <meta property="og:image" content="https://aaif-goose.github.io/goose/assets/images/cover-2ba7c2e15786be2db6108c91d27dc1ec.png" />
  ...
  <meta name="twitter:image" content="https://aaif-goose.github.io/goose/assets/images/cover-2ba7c2e15786be2db6108c91d27dc1ec.png" />
</head>