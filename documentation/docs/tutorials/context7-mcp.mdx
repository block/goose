...
This tutorial covers how to add the [Context7 MCP Server](https://glama.ai/mcp/servers/@upstash/context7-mcp) as a Goose extension to pull up-to-date, version-specific code and docs—so Goose can vibe code with real context, not hallucinated or outdated answers.
