...
```
Using the Playwright CLI skill, open aaif-goose.github.io/goose, click on the Docs menu, click on Context Engineering, 
...
1. Opens the browser: `playwright-cli open aaif-goose.github.io/goose`
...
test('navigate to Using Skills guide via docs menu', async ({ page }) => {
  await page.goto('https://aaif-goose.github.io/goose');
