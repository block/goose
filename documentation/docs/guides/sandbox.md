...
The [seatbelt sandbox profile](https://github.com/bfg-ent/goose/blob/main/ui/desktop/src/sandbox/index.ts) blocks write operations to these sensitive files:
