...
<Tabs groupId="interface">
  ...
  <TabItem value="cli" label="Goose CLI">
   Recipe files can be either JSON (.json) or YAML (.yaml) files. While in a [session](/docs/guides/sessions/managing-goose-sessions#start-session), run this command to generate a recipe.yaml file in your current directory:
...
<Tabs groupId="interface">
  ...
  <TabItem value="cli" label="Goose CLI">
   ...
   :::info
   If you want to validate a recipe you just created, you need to [exit the session](/docs/guides/sessions/managing-goose-sessions#exit-session) before running the [`validate` subcommand](/docs/guides/goose-cli-commands#recipe).
   :::
