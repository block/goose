...
You can turn a successful session into a reusable "[recipe](/docs/guides/recipes/shareable-recipes)" to share with others or use again later—no need to start from scratch.
