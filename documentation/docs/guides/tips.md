...
goose Desktop lets you [customize the sidebar](/docs/guides/desktop-navigation). Move it to any edge, switch between a tile grid and a compact list, or have it float over your content instead of pushing it aside.
