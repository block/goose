...
Turning on too many extensions can degrade performace. Enable only essential [extensions and tools](docs/guides/tool-permissions) to improve tool selection accuracy, save context window space, and stay within provider tool limits.
