...
<Tabs groupId="interface">
    ...
    <TabItem value="cli" label="goose CLI">
        ...
        :::tip
        While you can resume sessions using the commands above, we recommend creating new sessions for new tasks to reduce the chance of [doom spiraling](/docs/known-issues#stuck-in-a-loop-or-unresponsive).
        :::
    </TabItem>
</Tabs>
