...
| `GOOSE_TOOLSHIM` | Enables/disables [tool call interpretation](/docs/guides/tool-shim) | "1", "true" (case-insensitive) to enable | false |
| `GOOSE_TOOLSHIM_OLLAMA_MODEL` | Specifies the model for [tool call interpretation](/docs/guides/tool-shim) | Model name (e.g. llama3.2, qwen2.5) | System default |
