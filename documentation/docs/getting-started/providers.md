...
| [EUrouter](https://www.eurouter.ai/)                                        | European AI router with EU data residency. Provides Claude, GPT, Mistral, Qwen, DeepSeek, Kimi, GLM, and 120+ other models through one OpenAI-compatible API, with routing by price, latency, or throughput and automatic failover. goose offers the EUrouter models that support tool calling; see [the EUrouter model list](https://www.eurouter.ai/models) for the full catalog. | `EUROUTER_API_KEY`                                                                                                                                                                  |
