...
| [Infersia](https://infersia.com/)                                            | Open-weight models (DeepSeek, Qwen) served at their full context windows through an OpenAI-compatible API, with the serving [quantisation published](https://infersia.com/transparency) per endpoint. DeepSeek V4 Flash runs at its complete 1,048,576-token context. Catalog available at `https://api.infersia.com/v1/models`. | `INFERSIA_API_KEY`                                                                                                                                                                  |
