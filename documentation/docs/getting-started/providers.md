...
| [OpenAI Codex](https://developers.openai.com/codex/cli) (`codex`)          | **Deprecated: use `codex-acp` instead.** Uses OpenAI's Codex CLI tool with your ChatGPT Plus/Pro subscription.                                                                         | Codex CLI installed and authenticated, active ChatGPT Plus/Pro subscription                                                                                                          |
