...
| [Ollama](https://ollama.com/)                                               | Local and hosted model runner supporting Qwen, Llama, DeepSeek, and other open-source models. Use a local Ollama daemon by default, or connect directly to `ollama.com`.  | `OLLAMA_HOST`, `OLLAMA_API_KEY` (optional for direct `ollama.com` access)                                                                                                                                                                       |
  ...
  <TabItem value="ollama" label="Ollama" default>
    <Tabs groupId="ollama-models">
      ...
      <TabItem value="others" label="Other Models" default>
        ...
        For direct Ollama Cloud access, set `OLLAMA_HOST=https://ollama.com` and provide `OLLAMA_API_KEY`.
        :::
