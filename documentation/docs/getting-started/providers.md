...
| [OrcaRouter](https://www.orcarouter.ai/)                                    | Adaptive router that fronts OpenAI, Anthropic, Google, xAI, DeepSeek, and 150+ other frontier models behind a single OpenAI-compatible API. Authenticate with an `sk-orca-...` bearer key.                                | `ORCAROUTER_API_KEY`                                                                                                                                                                |
