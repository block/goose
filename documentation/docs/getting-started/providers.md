...
| [Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/) | Access Claude, GPT, Mistral, Llama, and DeepSeek models through Microsoft's Azure AI Foundry platform. Supports both Anthropic and OpenAI API formats based on model type. | `MICROSOFT_FOUNDRY_RESOURCE`, `MICROSOFT_FOUNDRY_API_KEY` |
