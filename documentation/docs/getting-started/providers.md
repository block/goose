...
| [OpenZoo](https://openzoo.fun/)                                             | OpenAI-compatible API with no signup — any API key value works and usage is paid per call (card or x402). Hosted endpoint plus a local gateway via `npx openzoo`. Models discovered dynamically from `/v1/models`.                                                                                                                                                                       | `OPENZOO_API_KEY`, `OPENZOO_HOST` (optional, default `https://api.openzoo.fun`)                                                                                                     |
