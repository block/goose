...
| [Friendli](https://friendli.ai/)                                            | Serverless inference for GLM, Qwen, DeepSeek, MiniMax, and Gemma models through an OpenAI-compatible API with dynamic model discovery.               | `FRIENDLI_TOKEN`                                                                                                                                                                  |
