...
| [Synthorai](https://synthorai.io)                                            | Models from Anthropic, OpenAI, Google, Z.ai, Moonshot, DeepSeek and Qwen through Synthorai's OpenAI-compatible API, billed at each upstream provider's own list price.                                                                            | `SYNTHORAI_API_KEY`                                                                                                                                                                  |
