...
| [The Grid](https://thegrid.ai)                                              | Spot market for inference. Model ids are market instruments -- a task type paired with a quality tier -- rather than fixed models, so each request is filled by whichever supplier is competitive at the time.                                   | `THEGRID_API_KEY`                                                                                                                                                                   |
