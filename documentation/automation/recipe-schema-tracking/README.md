...
This automation keeps the [Recipe Reference Guide](https://aaif-goose.github.io/goose/docs/guides/recipes/recipe-reference) synchronized with code changes by:
