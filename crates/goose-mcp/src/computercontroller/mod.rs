...
impl ComputerControllerServer {
    ...
    #[tool(
        ...
        description = "Create and run small scripts for automation tasks. Supports Shell and Ruby (on macOS)."
    )]
    ...
    #[tool(
        ...
        description = "Control the computer using system automation. Features vary by platform."
    )]
