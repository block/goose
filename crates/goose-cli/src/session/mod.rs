...
// Re-export types and functions from utils module for backward compatibility
pub use utils::{
    classify_planner_response, get_reasoner, summarize_context_messages, PlannerResponseType,
};
                            ...
                            if let Some(MessageContent::ToolConfirmationRequest(confirmation)) = message.content.first() {
                                ...
                                match selected {
                                    ...
                                    "summarize" => {
                                        ...
                                        summarize_context_messages(&mut self.messages, &self.agent, message_suffix).await?;
                                    }
                                    _ => {
                                        unreachable!()
                                    }
