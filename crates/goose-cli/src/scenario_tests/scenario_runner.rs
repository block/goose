    ...
    F: Fn(&ScenarioResult) -> Result<()>,
{
    ...
    let agent_config = AgentConfig::new(session_manager, permission_manager, None, GooseMode::Auto, &goose_mcp::BUILTIN_EXTENSIONS); // no scheduler needed for scenario tests
