...
pub struct ModelOptions {
    ...
    #[arg(
        ...
        long_help = "Override the GOOSE_PROVIDER environment variable for this run. Available providers include openai, anthropic, ollama, databricks, gemini-cli, copilot-cli, claude-code, and others."
    )]
