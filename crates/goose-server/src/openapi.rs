...
#[openapi(
    paths(
        ...
        super::routes::session::create_session,
        super::routes::session::open_session,
        super::routes::session::add_session_extension,
    ...
    components(schemas(
        ...
        super::routes::session::CreateSessionRequest,
        super::routes::session::OpenSessionRequest,
        super::routes::session::AddSessionExtensionRequest,
        Message,
        MessageContent,
        MessageMetadata,
        TokenState,
