...
#[openapi(
    paths(
        ...
        super::routes::analytics::store_run,
    ...
    components(schemas(
        ...
        // Analytics
        super::routes::analytics::StoreRunRequest,
        goose::eval::eval_storage::EvalDataset,
        goose::eval::eval_storage::EvalTestCase,
        goose::eval::eval_storage::EvalDatasetSummary,
        goose::eval::eval_storage::CreateDatasetRequest,
        goose::eval::eval_storage::CreateTestCaseRequest,
        goose::eval::eval_storage::EvalRunSummary,
        goose::eval::eval_storage::EvalRunDetail,
        goose::eval::eval_storage::AgentResult,
        goose::eval::eval_storage::FailureDetail,
        goose::eval::eval_storage::ConfusionMatrix,
        goose::eval::eval_storage::EvalOverview,
        goose::eval::eval_storage::AccuracyTrendPoint,
        goose::eval::eval_storage::RegressionAlert,
        goose::eval::eval_storage::RunEvalRequest,
        super::routes::analytics::EvalCaseResult,
        goose::eval::eval_storage::TopicAnalytics,
        goose::eval::eval_storage::TopicAgentDistribution,
        goose::eval::eval_storage::RunComparison,
        goose::eval::eval_storage::RunComparisonSide,
        goose::eval::eval_storage::FixedCase,
        goose::eval::eval_storage::AgentDelta,
        goose::eval::eval_storage::CorrelationInsight,
        goose::eval::tool_analytics::ToolAnalytics,
        goose::eval::tool_analytics::ToolUsageStat,
        goose::eval::tool_analytics::DailyToolActivity,
        goose::eval::tool_analytics::ExtensionUsageStat,
        goose::eval::tool_analytics::SessionToolSummary,
        goose::eval::tool_analytics::AgentPerformanceMetrics,
        goose::eval::tool_analytics::ProviderSessionStat,
        goose::eval::tool_analytics::DurationStats,
        goose::eval::tool_analytics::ActiveExtensionStat,
        goose::eval::tool_analytics::VersionInfo,
        goose::eval::tool_analytics::LiveMetrics,
        goose::eval::tool_analytics::HotTool,
        goose::eval::tool_analytics::RecentError,
        goose::eval::tool_analytics::MinuteActivity,
        goose::eval::tool_analytics::ResponseQualityMetrics,
        goose::eval::tool_analytics::DailyQuality,
        goose::eval::tool_analytics::ProviderQuality,
