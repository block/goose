...
#[openapi(
    paths(
        ...
        super::routes::projects::remove_project,
        super::routes::projects::update_current_project,
    ...
    components(schemas(
        ...
        super::routes::projects::ProjectsListResponse,
        super::routes::projects::ProjectInfoResponse,
        super::routes::projects::UpdateProjectRequest,
        super::routes::projects::UpdateProjectResponse,
        goose::projects::ProjectInfoDisplay,
        Message,
        MessageContent,
        MessageMetadata,
        ContentSchema,
