...
#[openapi(
    paths(
        ...
        super::routes::session::get_graph_insights,
    ...
    components(schemas(
        ...
        goose::session::GraphInsights,
        goose::session::GraphNode,
        goose::session::GraphLink,
        goose::session::DirectoryStats,
        goose::session::ProviderStats,
        goose::session::SessionTypeStats,
        goose::session::DailyActivity,
        goose::session::InsightsSummary,
        goose::session::graph_insights::NodeMetadata,
