...
#[openapi(
    ...
    components(schemas(
        ...
        super::routes::local_inference::RegistryModelResponse,
        super::routes::local_inference::ModelListItem,
        super::routes::local_inference::HfDownloadRequest,
        super::routes::local_inference::HfDownloadResponse,
