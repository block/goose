...
#[openapi(
    paths(
        ...
        super::routes::reply::stream_events,
        super::routes::reply::stream_reply,
        super::routes::reply::stream_cancel,
    ...
    components(schemas(
        ...
        super::routes::reply::StreamReplyRequest,
        super::routes::reply::StreamReplyResponse,
        super::routes::reply::CancelRequest,
