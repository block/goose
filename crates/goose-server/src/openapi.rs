...
#[openapi(
    paths(
        ...
        super::routes::sessions::list_sessions,
        super::routes::sessions::get_session,
        super::routes::sessions::get_session_insights,
        super::routes::sessions::update_session_name,
        super::routes::sessions::update_session_recipe,
        super::routes::sessions::delete_session,
        super::routes::sessions::export_session,
        super::routes::sessions::import_session,
        super::routes::sessions::create_session,
        super::routes::sessions::open_session,
        super::routes::sessions::add_session_extension,
        super::routes::sessions::remove_session_extension,
        super::routes::sessions::fork_message,
        super::routes::sessions::edit_message_in_place,
        super::routes::sessions::get_session_tools,
        super::routes::sessions::call_session_tool,
        super::routes::sessions::read_session_resource,
        super::routes::sessions::confirm_tool_action,
    ...
    components(schemas(
        ...
        super::routes::sessions::ImportSessionRequest,
        super::routes::sessions::SessionListResponse,
        super::routes::sessions::UpdateSessionNameRequest,
        super::routes::sessions::UpdateRecipeRequest,
        super::routes::sessions::UpdateRecipeResponse,
        super::routes::sessions::CreateSessionRequest,
        super::routes::sessions::OpenSessionRequest,
        super::routes::sessions::AddSessionExtensionRequest,
        super::routes::sessions::GetToolsQuery,
        super::routes::sessions::ReadResourceRequest,
        super::routes::sessions::ReadResourceResponse,
        super::routes::sessions::CallToolRequest,
        super::routes::sessions::CallToolResponse,
        super::routes::sessions::ConfirmToolActionRequest,
        super::routes::sessions::ForkMessageResponse,
        Message,
        MessageContent,
        MessageMetadata,
        TokenState,
