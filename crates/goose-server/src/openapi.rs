...
#[openapi(
    paths(
        ...
        super::routes::session_events::claw_session,
        super::routes::session_events::claw_reply,
    ...
    components(schemas(
        ...
        super::routes::session_events::ClawReplyRequest,
        super::routes::session_events::ClawSessionResponse,
