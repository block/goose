...
#[openapi(
    paths(
        ...
        super::routes::config_management::discover_extension,
    ...
    components(schemas(
        ...
        super::routes::config_management::DiscoverExtensionQuery,
        super::routes::config_management::DiscoverExtensionResponse,
        goose::mcp_discovery::TrustClass,
        goose::mcp_discovery::DiscoverySource,
