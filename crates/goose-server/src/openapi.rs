...
#[openapi(
    paths(
        ...
        super::routes::database::create_backup,
        super::routes::database::list_backups,
        super::routes::database::delete_backups,
        super::routes::database::restore_backup,
    ...
    components(schemas(
        ...
        super::routes::database::CreateBackupRequest,
        super::routes::database::CreateBackupResponse,
        super::routes::database::BackupsListResponse,
        super::routes::database::RestoreBackupRequest,
