...
#[openapi(
    paths(
        ...
        super::routes::agent::get_provider_info,
        super::routes::agent::get_plan_prompt,
    ...
    components(schemas(
        ...
        super::routes::agent::SessionIdQuery,
        super::routes::agent::ProviderInfoResponse,
        super::routes::agent::PlanPromptResponse,
