...
#[openapi(
    paths(
        ...
        super::routes::goose_bot::review,
        super::routes::goose_bot::setup,
        super::routes::goose_bot::disconnect,
        super::routes::goose_bot::get_status,
        super::routes::goose_bot::comment,
        super::routes::goose_bot::get_prefs,
        super::routes::goose_bot::put_prefs,
        super::routes::goose_bot::get_repos,
        super::routes::goose_bot::get_analytics,
    ...
    components(schemas(
        ...
        goose::goose_bot::GooseBotReviewRequest,
        goose::goose_bot::GooseBotReviewResponse,
        goose::goose_bot::GooseBotSetupResponse,
        goose::goose_bot::GooseBotStatusResponse,
        goose::goose_bot::GooseBotDisconnectResponse,
        goose::goose_bot::GooseBotCommentRequest,
        goose::goose_bot::GooseBotPrefsRequest,
        goose::goose_bot::GooseBotPrefsResponse,
        goose::goose_bot::GooseBotPrefs,
        goose::goose_bot::RoutingPrefs,
        goose::goose_bot::TriggerPreference,
        goose::goose_bot::TriggerPermission,
        goose::goose_bot::ReviewOutputStyle,
        goose::goose_bot::ReviewModelChoice,
        goose::goose_bot::ReviewSeverity,
        goose::goose_bot::GooseBotRepo,
        goose::goose_bot::GooseBotReposResponse,
        goose::goose_bot::RepoVisibility,
        goose::goose_bot::GooseBotAnalytics,
