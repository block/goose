...
#[openapi(
    paths(
        ...
        super::routes::config_management::get_telemetry_status,
        super::routes::config_management::set_telemetry_status,
    ...
    components(schemas(
        ...
        super::routes::config_management::TelemetryStatusResponse,
        super::routes::config_management::SetTelemetryRequest,
