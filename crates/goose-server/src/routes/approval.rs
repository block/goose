...
impl ApprovalState {
    ...
    #[allow(dead_code)] // Will be used when we migrate sampling and tool approval
...
impl goose::agents::approval::ApprovalHandler for ApprovalState {
    ...
    async fn request_sampling_approval(
        ...
        // Convert rmcp::model::SamplingMessage to our SamplingMessage
        let converted_messages: Vec<SamplingMessage> = messages
            .into_iter()
            .map(|msg| {
