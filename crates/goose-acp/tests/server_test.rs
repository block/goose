...
use common_tests::{
    ...
    run_prompt_mcp, run_text_editor_write_acp, run_text_editor_write_acp_status_updates,
};
...
#[test]
fn test_text_editor_write_acp_status_updates() {
    run_test(async { run_text_editor_write_acp_status_updates::<ClientToAgentConnection>().await });
}
