...
/// Newtype wrapper needed by `set_meter_provider`.
...
/// Saves and restores global tracer and meter providers on drop.
...
/// Locks all OTEL env vars, applies overrides, and returns a guard that restores
/// global providers on drop.
