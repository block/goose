...
pub fn dispatch(app: &mut App, input: &str) -> CommandResult {
    ...
    match command {
        ...
        "about" => {
            // Assuming showing_about_popup exists, otherwise ignore or remove
            // app.showing_about_popup = !app.showing_about_popup;
            // I didn't see showing_about_popup in App struct earlier.
            // Let's verify App struct.
            CommandResult::Continue
        }
        "theme" => {
        ...
        "border" => CommandResult::ToggleBorder,
