...
STDERR: 
STDERR: 
STDERR: [01/23/26 11:54:12] INFO     Starting MCP server 'mymcp' with     server.py:2506
...
STDIN: {"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"_meta":{"goose-session-id":"test-session-id","progressToken":0},"name":"divide","arguments":{"dividend":10,"divisor":2}}}
