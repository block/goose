...
1. **Fetch official docs**
   - Fetch the doc map from `https://aaif-goose.github.io/goose/goose-docs-map.md`
   ...
   - Fetch: `https://aaif-goose.github.io/goose/docs/guides/sessions/session-management.md`
...
5. **List documentation links**
   ...
   - Example: If you fetched `https://aaif-goose.github.io/goose/docs/guides/sessions/session-management.md`, list it as `https://aaif-goose.github.io/goose/docs/guides/sessions/session-management`
