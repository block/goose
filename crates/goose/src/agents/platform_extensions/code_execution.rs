                ...
                McpTool::new(
                    ...
                    indoc! {r#"
                        ...
                        async function run() {
                            ...
                            const readme = await Developer.read({ path: "./README.md" });
                            return { files, readme };
                        }
                        ```
                        ...
                        [
                          ...
                          {"tool": "Developer.read", "description": "read README.md", "depends_on": []},
                        ...
                        - Function names are always camelCase (e.g., Developer.read, Github.listIssues, Github.createIssue)
