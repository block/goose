...
use super::{GooseBotPrefs, ReviewModelChoice, ReviewOutputStyle};
...
pub fn build_goose_review_args(base: &str, head: &str, prefs: &GooseBotPrefs) -> Vec<String> {
...
"#;
    ...
    fn review_args_defaults() {
        let args = build_goose_review_args("base", "head", &GooseBotPrefs::default());
        assert_eq!(
            args,
    ...
    fn review_args_severity_reflects_pref() {
        use crate::goose_bot::ReviewSeverity;
