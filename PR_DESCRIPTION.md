...
2. Send your **1st message** (e.g., "My queries are really slow")
...
6. Open the browser dev tools Network tab and send a 5th message
   - **Verify no `GET /sessions/{id}` API calls are made** - the refresh logic has stopped
