...
The `/acp/v1/*` endpoints are designed for external enterprise control planes (Azure AI Controls, GitHub Enterprise, AWS):

| Endpoint | Method | Purpose |
|---|---|---|
| `/acp/v1/info` | GET | System capabilities, version, features |
| `/acp/v1/policies` | GET/POST | List/create policy rules |
| `/acp/v1/policies/:id` | DELETE | Remove a policy rule |
| `/acp/v1/quotas` | GET/POST | List/create quota limits |
| `/acp/v1/quotas/check` | POST | Check if a scope is within limits |
| `/acp/v1/audit` | GET | Recent audit events |
| `/acp/v1/agents` | GET/POST | List/register agents |
| `/acp/v1/agents/:name` | DELETE | Unregister an agent |
...
- `POST /acp/v1/policies` → `manage:policies`
