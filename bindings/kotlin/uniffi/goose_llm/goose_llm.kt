...
public typealias FfiConverterTypeValue = FfiConverterString
 ...
 fun `createCompletionRequest`(`providerName`: kotlin.String, `providerConfig`: Value, `modelConfig`: ModelConfig, `systemPreamble`: kotlin.String, `messages`: List<Message>, `extensions`: List<ExtensionConfig>): CompletionRequest {
            return FfiConverterTypeCompletionRequest.lift(
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_goose_llm_fn_func_create_completion_request(
        FfiConverterString.lower(`providerName`),FfiConverterTypeValue.lower(`providerConfig`),FfiConverterTypeModelConfig.lower(`modelConfig`),FfiConverterString.lower(`systemPreamble`),FfiConverterSequenceTypeMessage.lower(`messages`),FfiConverterSequenceTypeExtensionConfig.lower(`extensions`),_status)
}
    )
    }
