...
type ElectronAPI = {
  ...
  // Installation completion notification method
  notifyInstallationComplete: (success: boolean) => void;
};
...
const electronAPI: ElectronAPI = {
  ...
  notifyInstallationComplete: (success: boolean) =>
    ipcRenderer.send('installation-complete', success),
};
