...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'Avocado Work is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'Avocado Work is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'Avocado Work is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'Avocado Work is compacting the conversation...',
  },
  idle: {
