...
import type { SyncState } from './useGooseBotPrefs';

const i18n = defineMessages({
  loading: {
    id: 'gooseBotSaveIndicator.loading',
    defaultMessage: 'Loading...',
  },
  syncing: {
    id: 'gooseBotSaveIndicator.syncing',
    defaultMessage: 'Saving...',
  },
  saved: {
    id: 'gooseBotSaveIndicator.saved',
    defaultMessage: 'Saved',
  },
  savedPending: {
    id: 'gooseBotSaveIndicator.savedPending',
    defaultMessage: 'Saved locally - webhook sync pending',
  },
  failed: {
    id: 'gooseBotSaveIndicator.failed',
    defaultMessage: "Couldn't save",
  },
  retry: {
    id: 'gooseBotSaveIndicator.retry',
