...
const i18n = defineMessages({
  customInstructionsTitle: {
    id: 'gooseBotGeneral.customInstructionsTitle',
    defaultMessage: 'Custom instructions',
  },
  customInstructionsDescription: {
    id: 'gooseBotGeneral.customInstructionsDescription',
    defaultMessage:
  ...
  customInstructionsPlaceholder: {
    id: 'gooseBotGeneral.customInstructionsPlaceholder',
    defaultMessage:
  ...
  customInstructionsHelper: {
    id: 'gooseBotGeneral.customInstructionsHelper',
    defaultMessage:
...
export default function GooseBotGeneral({ prefs, onUpdate }: Props) {
  const intl = useIntl();
