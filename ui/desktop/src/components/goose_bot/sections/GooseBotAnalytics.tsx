...
import { useGooseBotAnalytics } from '../useGooseBotAnalytics';
...
const i18n = defineMessages({
  prsReviewed: {
    id: 'gooseBotAnalytics.prsReviewed',
    defaultMessage: 'PRs reviewed',
  },
  issuesHandled: {
    id: 'gooseBotAnalytics.issuesHandled',
    defaultMessage: 'Issues handled',
  },
  commitsPushed: {
    id: 'gooseBotAnalytics.commitsPushed',
    defaultMessage: 'Commits pushed',
  },
  loadFailed: {
    id: 'gooseBotAnalytics.loadFailed',
    defaultMessage: 'Could not load analytics',
  },
  retry: {
    id: 'gooseBotAnalytics.retry',
    defaultMessage: 'Retry',
  },
});

export default function GooseBotAnalyticsSection({ enabled }: Props) {
  const intl = useIntl();
  const { state, refresh } = useGooseBotAnalytics(enabled);
