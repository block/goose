...
import { disconnectGooseBot, startGooseBotSetup } from '../../../utils/gooseBotSetup';
import { errorMessage } from '../../../utils/conversionUtils';
import { defineMessages, useIntl } from '../../../i18n';
import type { StoredInstall } from '../GooseBotView';

const i18n = defineMessages({
  githubTitle: {
    id: 'gooseBotConnectors.githubTitle',
    defaultMessage: 'GitHub',
  },
  githubDescription: {
    id: 'gooseBotConnectors.githubDescription',
    defaultMessage: 'Install the Goose Bot GitHub App on the repos you want auto-reviewed.',
  },
  installAction: {
    id: 'gooseBotConnectors.installAction',
    defaultMessage: 'Connect GitHub',
  },
  disconnectAction: {
    id: 'gooseBotConnectors.disconnectAction',
    defaultMessage: 'Disconnect',
  },
  manageAction: {
    id: 'gooseBotConnectors.manageAction',
    defaultMessage: 'Manage on GitHub',
  },
  connectedLabel: {
    id: 'gooseBotConnectors.connectedLabel',
    defaultMessage: 'Connected - installation {id}',
  },
  notConnected: {
    id: 'gooseBotConnectors.notConnected',
    defaultMessage: 'Not connected',
  },
  awaitingInstall: {
    id: 'gooseBotConnectors.awaitingInstall',
    defaultMessage: 'Finish installing on GitHub in your browser...',
  },
  awaitingInstallHint: {
    id: 'gooseBotConnectors.awaitingInstallHint',
    defaultMessage:
      'A browser tab just opened to GitHub. Pick the repos you want reviewed and click Install & Authorize.',
  },
  setupFailed: {
    id: 'gooseBotConnectors.setupFailed',
    defaultMessage: 'Failed to connect Goose Bot',
  },
  disconnectHint: {
    id: 'gooseBotConnectors.disconnectHint',
    defaultMessage:
...
export default function GooseBotConnectors({
  tunnelInfo,
  stored,
  onInstallSaved,
  onInstallCleared,
  ...
  const handleConnect = async () => {
    ...
    setBusy(true);
    try {
      const body = await startGooseBotSetup();
      onInstallSaved({
