...
import { ConfigureExtensionModal } from "./ConfigureExtensionModal";
...
export default function Settings() {
  ...
  const [configuringExtension, setConfiguringExtension] = useState<FullExtensionConfig | null>(null);
  ...
  const handleConfigureExtension = (extension: FullExtensionConfig) => {
    setConfiguringExtension(extension);
  };
