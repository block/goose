...
import { Bot, Share2, Monitor, MessageSquare, FileText, Keyboard, HardDrive, Zap } from 'lucide-react';
            ...
            >
              <div className="px-1">
                <TabsList className="w-full mb-2 justify-start overflow-x-auto flex-nowrap">
                  ...
                  <TabsTrigger value="wallet" className="flex gap-2" data-testid="settings-wallet-tab">
