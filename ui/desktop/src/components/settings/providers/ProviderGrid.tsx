    ...
    async (provider: ProviderDetails) => {
      if (provider.provider_type === 'Custom' || provider.provider_type === 'Declarative') {
        ...
        if (result.data) {
          ...
          // Use wizard for autogenerated providers, old form for manual
          if (result.data.config.autogenerated) {
  ...
  return (
    <>
      ...
      <CustomProviderWizard
        ...
        initialData={editingProvider?.config.autogenerated ? initialData : null}
