        ...
        <div className="px-8 pt-6 pb-4">
          ...
          {isOnboarding && (
            <p className="text-s text-textSubtle max-w-2xl pt-2">
              Select an AI model provider to get started with Goose. You'll need to use API
              keys generated by each provider which will be encrypted and stored locally. You can
