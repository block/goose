    ...
    <div className="w-full">
      {canDelete && onDelete && (
        <Button
          type="button"
          onClick={onDelete}
          className="w-full h-[60px] rounded-none border-t border-border-default bg-transparent hover:bg-bgSubtle text-red-500 font-medium text-md"
        >
      ...
      {requiredParameters && requiredParameters.length > 0 ? (
        <>
          <Button
            ...
            variant="ghost"
            onClick={onSubmit}
            className="w-full h-[60px] rounded-none border-t border-border-default text-md hover:bg-bgSubtle text-text-default font-medium"
          >
            Submit
          </Button>
          <Button
            ...
            variant="ghost"
            onClick={onCancel}
            className="w-full h-[60px] rounded-none border-t border-border-default hover:text-text-default text-text-muted hover:bg-bgSubtle text-md font-regular"
          >
            Cancel
          </Button>
        </>
