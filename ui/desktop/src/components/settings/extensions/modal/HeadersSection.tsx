...
export default function HeadersSection({
  ...
  const handleAdd = () => {
    ...
    if (keyEmpty || valueEmpty) {
      ...
      setValidationError(t('extensionModal.headers.validationRequired'));
      return;
    }
    ...
    if (keyHasSpaces) {
      ...
      setValidationError(t('extensionModal.headers.validationNoSpaces'));
      return;
    }
    ...
    if (isDuplicate) {
      ...
      setValidationError(t('extensionModal.headers.validationDuplicate'));
      return;
    }
    ...
    <div>
      <div className="relative mb-2">
        <label className="text-sm font-medium text-text-primary mb-2 block">
          {t('extensionModal.headers.title')}
        </label>
        <p className="text-xs text-text-secondary mb-4">
          {t('extensionModal.headers.description')}
        </p>
      </div>
          ...
          <React.Fragment key={index}>
            <div className="relative">
              <Input
                ...
                placeholder={t('extensionModal.headers.headerNamePlaceholder')}
                className={cn(
            ...
            <div className="relative">
              <Input
                ...
                placeholder={t('extensionModal.headers.valuePlaceholder')}
                className={cn(
                  'w-full text-text-primary border-border-primary hover:border-border-primary',
