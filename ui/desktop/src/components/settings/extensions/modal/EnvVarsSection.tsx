...
export default function EnvVarsSection({
  ...
  const handleAdd = () => {
    ...
    if (keyEmpty || valueEmpty) {
      ...
      setValidationError(t('extensionModal.envVars.validationRequired'));
      return;
    }
    ...
    if (keyHasSpaces) {
      ...
      setValidationError(t('extensionModal.envVars.validationNoSpaces'));
      return;
    }
    ...
    <div>
      <div className="relative mb-2">
        <label className="text-sm font-medium text-text-primary mb-2 block">
          {t('extensionModal.envVars.title')}
        </label>
        <p className="text-xs text-text-secondary mb-4">
          {t('extensionModal.envVars.description')}
        </p>
      </div>
          ...
          <React.Fragment key={index}>
            <div className="relative">
              <Input
                ...
                placeholder={t('extensionModal.envVars.variableNamePlaceholder')}
                className={cn(
            ...
            <div className="relative">
              <Input
                ...
                placeholder={t('extensionModal.envVars.valuePlaceholder')}
                className={cn(
