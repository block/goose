...
export default function ExtensionModal({
  ...
  const modalTitle = showDeleteConfirmation
    ? t('extensionModal.deleteExtensionTitle', { name: formData.name })
    : title;
    ...
    <>
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            {showDeleteConfirmation && (
              <DialogDescription>
                {t('extensionModal.deleteDescription')}
              </DialogDescription>
            )}
          </DialogHeader>
          ...
          {showDeleteConfirmation ? (
            <div className="py-4">
              <p className="text-text-primary">{t('extensionModal.deleteDescription')}</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-text-primary mb-1">
                        {t('extensionModal.installationNotes')}
                      </h4>
            ...
            {showDeleteConfirmation ? (
              <>
                ...
                >
                  ...
                  {t('extensionModal.confirmRemoval')}
                </Button>
              </>
            ) : (
              <>
                {modalType === 'edit' && onDelete && (
                  ...
                  >
                    <Trash2 className="h-4 w-4 mr-2" />
                    {t('extensionModal.removeExtension')}
                  </Button>
                )}
      ...
      {showCloseConfirmation && (
        <ConfirmationModal
          ...
          title={t('extensionModal.unsavedChangesTitle')}
          message={t('extensionModal.unsavedChangesMessage')}
          confirmLabel={t('extensionModal.closeWithoutSaving')}
