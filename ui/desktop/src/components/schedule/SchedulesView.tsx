...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Create and manage scheduled tasks to run task templates automatically at specified times.',
  },
  ...
  confirmDelete: {
    ...
    defaultMessage: 'Remove schedule "{id}"? The task template will be kept.',
  },
