  ...
  ({ onSelectSession, selectedSessionId }) => {
    ...
    const loadSessions = useCallback(async () => {
      ...
      try {
        ...
        setError(errorMessage(err, t('sessions.errorLoading')));
        setSessions([]);
        setFilteredSessions([]);
      } finally {
        setIsLoading(false);
    ...
    const handleDuplicateSession = useCallback(
      async (session: Session) => {
        try {
          ...
          toast.success(t('sessions.duplicateSuccess', { name: session.name }));
          await loadSessions();
        } catch (error) {
          console.error('Error duplicating session:', error);
          toast.error(
            t('sessions.duplicateFailed', {
    ...
    const handleConfirmDelete = useCallback(async () => {
      ...
      try {
        ...
        toast.success(t('sessions.deletedSuccess'));
        window.dispatchEvent(
      ...
      await loadSessions();
    }, [sessionToDelete, loadSessions, t]);
    ...
    const handleImportSession = useCallback(
      async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
          ...
          toast.success(t('sessions.importSuccess'));
          await loadSessions();
        } catch (error) {
          toast.error(
