...
export function TreeItem({
  label, icon, expanded: controlledExpanded, defaultExpanded = false,
  onToggle, childCount, badge, children, indent = 0, className,
}: TreeItemProps) {
  ...
  return (
    <div className={className}>
      ...
      {hasChildren && isExpanded && (
        <div className="border-l border-border-default ml-5">
          {children}
        </div>
      )}
    </div>
