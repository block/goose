  ...
  return (
    <>
      ...
      <div ref={containerRef} className={cn(containerClasses, isPip && 'group/pip')} style={containerStyle}>
        {isPip && (
          <div className="pointer-events-none sticky top-0 z-20 flex h-0 items-start justify-between p-1.5 opacity-0 transition-opacity group-hover/pip:pointer-events-auto group-hover/pip:opacity-100">
            <div
