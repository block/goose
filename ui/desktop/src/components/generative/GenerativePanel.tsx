 ...
 *
 * It can be used:
 * 1. Inline in the chat stream (as structured content from tools)
 * 2. As a floating panel from the prompt bar
 * 3. As a standalone generative view
 */
...
interface GenerativePanelProps {
  /** The JSON spec to render — a tree of component nodes */
        ...
        <StateProvider initialState={initialState}>
          <VisibilityProvider>
            <ActionProvider handlers={actionHandlers()}>
              {/* @ts-ignore — json-render zod 3/4 type mismatch */}
              <Renderer
                spec={spec}
                registry={registry}
                loading={isStreaming}
