        ...
        <div className="space-y-4">
          <div className="flex gap-2 items-stretch">
            <input
              ...
              className="flex-1 px-3 py-2 border rounded-lg bg-background-primary text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              disabled={isLoading}
              onKeyDown={(e) => {
