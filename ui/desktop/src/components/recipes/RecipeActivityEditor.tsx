...
const i18n = defineMessages({
  ...
  activitiesDescription: {
    ...
    defaultMessage:
      'The top-line prompts and activity buttons that will display in the task template chat window.',
  },
  messageLabel: {
  ...
  messageDescription: {
    ...
    defaultMessage:
      'A formatted message that will appear at the top of the task template. Supports markdown formatting.',
  },
  messagePlaceholder: {
  ...
  activityButtonsDescription: {
    ...
    defaultMessage:
      'Clickable buttons that will appear below the message to help users interact with your task template.',
  },
