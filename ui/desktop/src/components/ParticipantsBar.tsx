...
export const ParticipantsBar: React.FC<ParticipantsBarProps> = ({ 
  ...
  if (currentRoom.members.length === 2) {
    ...
    return (
      <div className={`participants-bar-container flex items-center gap-2 px-4 py-2 sticky top-0 ${className}`}>
        <AvatarImage
  ...
  return (
    <div className={`participants-bar-container flex items-center gap-3 px-4 py-2 sticky top-0 ${className}`}>
