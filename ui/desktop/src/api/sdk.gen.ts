...
import type {
  AddSubRecipesData,
  AddSubRecipesResponse2,
  ExtendPromptData,
  ExtendPromptResponse2,
  UpdateSessionConfigData,
  UpdateSessionConfigResponse,
  GetToolsData,
  GetToolsResponse,
  UpdateAgentProviderData,
  UpdateRouterToolSelectorData,
  UpdateRouterToolSelectorResponse,
  ReadAllConfigData,
  ReadAllConfigResponse,
  BackupConfigData,
  BackupConfigResponse,
  CreateCustomProviderData,
  CreateCustomProviderResponse,
  RemoveCustomProviderData,
  RemoveCustomProviderResponse,
  GetExtensionsData,
  ...
  InitConfigData,
  InitConfigResponse,
  UpsertPermissionsData,
  UpsertPermissionsResponse,
  ProvidersData,
  ProvidersResponse2,
  ReadConfigData,
  RecoverConfigData,
  RecoverConfigResponse,
  RemoveConfigData,
  ...
  DecodeRecipeData,
  DecodeRecipeResponse2,
  EncodeRecipeData,
  EncodeRecipeResponse2,
  CreateScheduleData,
  ...
  InspectRunningJobData,
  InspectRunningJobResponse,
  KillRunningJobData,
  PauseScheduleData,
  PauseScheduleResponse,
  RunNowHandlerData,
  RunNowHandlerResponse,
  SessionsHandlerData,
  SessionsHandlerResponse,
  UnpauseScheduleData,
...
export const addSubRecipes = <ThrowOnError extends boolean = false>(
  options: Options<AddSubRecipesData, ThrowOnError>
) => {
...
export const extendPrompt = <ThrowOnError extends boolean = false>(
  options: Options<ExtendPromptData, ThrowOnError>
) => {
...
export const updateSessionConfig = <ThrowOnError extends boolean = false>(
  options: Options<UpdateSessionConfigData, ThrowOnError>
) => {
...
export const updateAgentProvider = <ThrowOnError extends boolean = false>(
  options: Options<UpdateAgentProviderData, ThrowOnError>
) => {
...
export const updateRouterToolSelector = <ThrowOnError extends boolean = false>(
  options?: Options<UpdateRouterToolSelectorData, ThrowOnError>
) => {
...
export const readAllConfig = <ThrowOnError extends boolean = false>(
  options?: Options<ReadAllConfigData, ThrowOnError>
) => {
...
export const createCustomProvider = <ThrowOnError extends boolean = false>(
  options: Options<CreateCustomProviderData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    CreateCustomProviderResponse,
    unknown,
...
export const removeCustomProvider = <ThrowOnError extends boolean = false>(
  options: Options<RemoveCustomProviderData, ThrowOnError>
) => {
...
export const addExtension = <ThrowOnError extends boolean = false>(
  options: Options<AddExtensionData, ThrowOnError>
) => {
...
export const removeExtension = <ThrowOnError extends boolean = false>(
  options: Options<RemoveExtensionData, ThrowOnError>
) => {
...
export const initConfig = <ThrowOnError extends boolean = false>(
  options?: Options<InitConfigData, ThrowOnError>
) => {
...
export const upsertPermissions = <ThrowOnError extends boolean = false>(
  options: Options<UpsertPermissionsData, ThrowOnError>
) => {
...
export const providers = <ThrowOnError extends boolean = false>(
  options?: Options<ProvidersData, ThrowOnError>
) => {
...
export const readConfig = <ThrowOnError extends boolean = false>(
  options: Options<ReadConfigData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
    url: '/config/read',
    ...options,
...
export const recoverConfig = <ThrowOnError extends boolean = false>(
  options?: Options<RecoverConfigData, ThrowOnError>
) => {
...
export const removeConfig = <ThrowOnError extends boolean = false>(
  options: Options<RemoveConfigData, ThrowOnError>
) => {
...
export const validateConfig = <ThrowOnError extends boolean = false>(
  options?: Options<ValidateConfigData, ThrowOnError>
) => {
...
export const confirmPermission = <ThrowOnError extends boolean = false>(
  options: Options<ConfirmPermissionData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
    url: '/confirm',
    ...options,
...
export const manageContext = <ThrowOnError extends boolean = false>(
  options: Options<ManageContextData, ThrowOnError>
) => {
...
export const decodeRecipe = <ThrowOnError extends boolean = false>(
  options: Options<DecodeRecipeData, ThrowOnError>
) => {
...
export const encodeRecipe = <ThrowOnError extends boolean = false>(
  options: Options<EncodeRecipeData, ThrowOnError>
) => {
...
export const inspectRunningJob = <ThrowOnError extends boolean = false>(
  options: Options<InspectRunningJobData, ThrowOnError>
) => {
...
export const killRunningJob = <ThrowOnError extends boolean = false>(
  options: Options<KillRunningJobData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
...
export const runNowHandler = <ThrowOnError extends boolean = false>(
  options: Options<RunNowHandlerData, ThrowOnError>
) => {
...
export const sessionsHandler = <ThrowOnError extends boolean = false>(
  options: Options<SessionsHandlerData, ThrowOnError>
) => {
...
export const unpauseSchedule = <ThrowOnError extends boolean = false>(
  options: Options<UnpauseScheduleData, ThrowOnError>
) => {
