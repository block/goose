...
export const counsel = <ThrowOnError extends boolean = false>(options: Options<CounselData, ThrowOnError>) => {
    return (options.client ?? client).post<CounselResponses, CounselErrors, ThrowOnError>({
        url: '/counsel',
        ...options,
        headers: {
            'Content-Type': 'application/json',
