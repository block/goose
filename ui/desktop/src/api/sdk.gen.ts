...
export const getPlanPrompt = <ThrowOnError extends boolean = false>(options: Options<GetPlanPromptData, ThrowOnError>) => (options.client ?? client).get<GetPlanPromptResponses, GetPlanPromptErrors, ThrowOnError>({ url: '/agent/plan_prompt', ...options });

export const getProviderInfo = <ThrowOnError extends boolean = false>(options: Options<GetProviderInfoData, ThrowOnError>) => (options.client ?? client).get<GetProviderInfoResponses, GetProviderInfoErrors, ThrowOnError>({ url: '/agent/provider_info', ...options });
