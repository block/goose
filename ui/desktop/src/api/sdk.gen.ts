...
export const streamEvents = <ThrowOnError extends boolean = false>(options: Options<StreamEventsData, ThrowOnError>) => (options.client ?? client).sse.get<StreamEventsResponses, StreamEventsErrors, ThrowOnError>({ url: '/reply/stream/{session_id}', ...options });

export const streamReply = <ThrowOnError extends boolean = false>(options: Options<StreamReplyData, ThrowOnError>) => (options.client ?? client).post<StreamReplyResponses, StreamReplyErrors, ThrowOnError>({
...
export const streamCancel = <ThrowOnError extends boolean = false>(options: Options<StreamCancelData, ThrowOnError>) => (options.client ?? client).post<StreamCancelResponses, unknown, ThrowOnError>({
