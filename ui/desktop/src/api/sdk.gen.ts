 ...
 */
export const discoverExtension = <ThrowOnError extends boolean = false>(options: Options<DiscoverExtensionData, ThrowOnError>) => (options.client ?? client).post<DiscoverExtensionResponses, DiscoverExtensionErrors, ThrowOnError>({
