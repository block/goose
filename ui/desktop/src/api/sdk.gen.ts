...
export const streamSession = <ThrowOnError extends boolean = false>(options: Options<StreamSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StreamSessionResponses, StreamSessionErrors, ThrowOnError>({
