...
export const getTelemetryStatus = <ThrowOnError extends boolean = false>(options?: Options<GetTelemetryStatusData, ThrowOnError>) => (options?.client ?? client).get<GetTelemetryStatusResponses, unknown, ThrowOnError>({ url: '/config/telemetry', ...options });

export const setTelemetryStatus = <ThrowOnError extends boolean = false>(options: Options<SetTelemetryStatusData, ThrowOnError>) => (options.client ?? client).post<SetTelemetryStatusResponses, SetTelemetryStatusErrors, ThrowOnError>({
