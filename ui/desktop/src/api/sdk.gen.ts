...
export const branchSession = <ThrowOnError extends boolean = false>(options: Options<BranchSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BranchSessionResponse2, unknown, ThrowOnError>({
