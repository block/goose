...
export const restartAgent = <ThrowOnError extends boolean = false>(options: Options<RestartAgentData, ThrowOnError>) => {
    return (options.client ?? client).post<RestartAgentResponses, RestartAgentErrors, ThrowOnError>({
        url: '/agent/restart',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const updateWorkingDir = <ThrowOnError extends boolean = false>(options: Options<UpdateWorkingDirData, ThrowOnError>) => {
    return (options.client ?? client).post<UpdateWorkingDirResponses, UpdateWorkingDirErrors, ThrowOnError>({
...
export const resetAllPrompts = <ThrowOnError extends boolean = false>(options?: Options<ResetAllPromptsData, ThrowOnError>) => {
    return (options?.client ?? client).delete<ResetAllPromptsResponses, ResetAllPromptsErrors, ThrowOnError>({
        url: '/config/prompts',
        ...options
    });
};
...
export const getPrompts = <ThrowOnError extends boolean = false>(options?: Options<GetPromptsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetPromptsResponses, unknown, ThrowOnError>({
        url: '/config/prompts',
        ...options
    });
};
...
export const resetPrompt = <ThrowOnError extends boolean = false>(options: Options<ResetPromptData, ThrowOnError>) => {
    return (options.client ?? client).delete<ResetPromptResponses, ResetPromptErrors, ThrowOnError>({
...
export const savePrompt = <ThrowOnError extends boolean = false>(options: Options<SavePromptData, ThrowOnError>) => {
    return (options.client ?? client).put<SavePromptResponses, SavePromptErrors, ThrowOnError>({
        url: '/config/prompts/{name}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const recipeToYaml = <ThrowOnError extends boolean = false>(options: Options<RecipeToYamlData, ThrowOnError>) => {
    return (options.client ?? client).post<RecipeToYamlResponses, RecipeToYamlErrors, ThrowOnError>({
        url: '/recipes/to-yaml',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const getSessionExtensions = <ThrowOnError extends boolean = false>(options: Options<GetSessionExtensionsData, ThrowOnError>) => {
    return (options.client ?? client).get<GetSessionExtensionsResponses, GetSessionExtensionsErrors, ThrowOnError>({
