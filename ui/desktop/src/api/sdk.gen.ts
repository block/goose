...
export const saveRecipeToFile = <ThrowOnError extends boolean = false>(options: Options<SaveRecipeToFileData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SaveRecipeToFileResponses, SaveRecipeToFileErrors, ThrowOnError>({
