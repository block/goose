...
export const listApps = <ThrowOnError extends boolean = false>(options?: Options<ListAppsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListAppsResponse, ListAppsError, ThrowOnError>({
        url: '/apps/list_apps',
        ...options
    });
};
