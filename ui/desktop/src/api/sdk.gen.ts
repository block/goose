...
export const getActivityHeatmap = <ThrowOnError extends boolean = false>(options?: Options<GetActivityHeatmapData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetActivityHeatmapResponse, unknown, ThrowOnError>({
        url: '/sessions/activity-heatmap',
        ...options
    });
};
