...
export const walletBalance = <ThrowOnError extends boolean = false>(options?: Options<WalletBalanceData, ThrowOnError>) => (options?.client ?? client).get<WalletBalanceResponses, WalletBalanceErrors, ThrowOnError>({ url: '/wallet/balance', ...options });

export const walletEvents = <ThrowOnError extends boolean = false>(options?: Options<WalletEventsData, ThrowOnError>) => (options?.client ?? client).get<WalletEventsResponses, unknown, ThrowOnError>({ url: '/wallet/events', ...options });

export const walletCreateInvoice = <ThrowOnError extends boolean = false>(options: Options<WalletCreateInvoiceData, ThrowOnError>) => (options.client ?? client).post<WalletCreateInvoiceResponses, WalletCreateInvoiceErrors, ThrowOnError>({
    url: '/wallet/invoice',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const walletParseInvoice = <ThrowOnError extends boolean = false>(options: Options<WalletParseInvoiceData, ThrowOnError>) => (options.client ?? client).post<WalletParseInvoiceResponses, WalletParseInvoiceErrors, ThrowOnError>({
...
export const walletPay = <ThrowOnError extends boolean = false>(options: Options<WalletPayData, ThrowOnError>) => (options.client ?? client).post<WalletPayResponses, WalletPayErrors, ThrowOnError>({
    url: '/wallet/pay',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const walletStatus = <ThrowOnError extends boolean = false>(options?: Options<WalletStatusData, ThrowOnError>) => (options?.client ?? client).get<WalletStatusResponses, unknown, ThrowOnError>({ url: '/wallet/status', ...options });
