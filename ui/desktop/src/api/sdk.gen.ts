...
export const getCanonicalModelInfo = <ThrowOnError extends boolean = false>(options: Options<GetCanonicalModelInfoData, ThrowOnError>) => (options.client ?? client).post<GetCanonicalModelInfoResponses, GetCanonicalModelInfoErrors, ThrowOnError>({
