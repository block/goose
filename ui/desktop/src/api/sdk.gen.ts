...
export const getActiveTheme = <ThrowOnError extends boolean = false>(options?: Options<GetActiveThemeData, ThrowOnError>) => (options?.client ?? client).get<GetActiveThemeResponses, unknown, ThrowOnError>({ url: '/theme/active', ...options });

export const applyThemePreset = <ThrowOnError extends boolean = false>(options: Options<ApplyThemePresetData, ThrowOnError>) => (options.client ?? client).post<ApplyThemePresetResponses, ApplyThemePresetErrors, ThrowOnError>({
...
export const getThemePresets = <ThrowOnError extends boolean = false>(options?: Options<GetThemePresetsData, ThrowOnError>) => (options?.client ?? client).get<GetThemePresetsResponses, unknown, ThrowOnError>({ url: '/theme/presets', ...options });

export const saveTheme = <ThrowOnError extends boolean = false>(options: Options<SaveThemeData, ThrowOnError>) => (options.client ?? client).post<SaveThemeResponses, SaveThemeErrors, ThrowOnError>({
    url: '/theme/save',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const saveCustomTheme = <ThrowOnError extends boolean = false>(options: Options<SaveCustomThemeData, ThrowOnError>) => (options.client ?? client).post<SaveCustomThemeResponses, SaveCustomThemeErrors, ThrowOnError>({
...
export const deleteCustomTheme = <ThrowOnError extends boolean = false>(options: Options<DeleteCustomThemeData, ThrowOnError>) => (options.client ?? client).delete<DeleteCustomThemeResponses, DeleteCustomThemeErrors, ThrowOnError>({ url: '/theme/saved/{id}', ...options });

export const getThemeVariables = <ThrowOnError extends boolean = false>(options?: Options<GetThemeVariablesData, ThrowOnError>) => (options?.client ?? client).get<GetThemeVariablesResponses, unknown, ThrowOnError>({ url: '/theme/variables', ...options });
