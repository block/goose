...
export const branchSession = <ThrowOnError extends boolean = false>(options: Options<BranchSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BranchSessionResponses, BranchSessionErrors, ThrowOnError>({
...
export const updateSessionMetadata = <ThrowOnError extends boolean = false>(options: Options<UpdateSessionMetadataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateSessionMetadataResponses, UpdateSessionMetadataErrors, ThrowOnError>({
