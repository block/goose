 ...
 */
export const mcpAppsProxy = <ThrowOnError extends boolean = false>(options: Options<McpAppsProxyData, ThrowOnError>) => (options.client ?? client).get<McpAppsProxyResponses, McpAppsProxyErrors, ThrowOnError>({ url: '/mcp-apps-proxy', ...options });
 ...
 */
export const getHostContext = <ThrowOnError extends boolean = false>(options?: Options<GetHostContextData, ThrowOnError>) => (options?.client ?? client).get<GetHostContextResponses, unknown, ThrowOnError>({ url: '/mcp-apps/context', ...options });
 ...
 */
export const handleUiMessage = <ThrowOnError extends boolean = false>(options: Options<HandleUiMessageData, ThrowOnError>) => (options.client ?? client).post<HandleUiMessageResponses, HandleUiMessageErrors, ThrowOnError>({
