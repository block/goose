...
export const approvalStream = <ThrowOnError extends boolean = false>(options?: Options<ApprovalStreamData, ThrowOnError>) => {
    return (options?.client ?? client).get<ApprovalStreamResponses, ApprovalStreamErrors, ThrowOnError>({
        url: '/approval',
        ...options
    });
};
...
export const submitApprovalResponse = <ThrowOnError extends boolean = false>(options: Options<SubmitApprovalResponseData, ThrowOnError>) => {
    return (options.client ?? client).post<SubmitApprovalResponseResponses, SubmitApprovalResponseErrors, ThrowOnError>({
        url: '/approval',
        ...options,
        headers: {
            'Content-Type': 'application/json',
