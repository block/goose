...
export const checkOauthCompletion = <ThrowOnError extends boolean = false>(options: Options<CheckOauthCompletionData, ThrowOnError>) => (options.client ?? client).get<CheckOauthCompletionResponses, CheckOauthCompletionErrors, ThrowOnError>({ url: '/config/providers/{name}/oauth/completion', ...options });
