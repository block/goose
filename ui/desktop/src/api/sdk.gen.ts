...
export const updateSessionWorkingDir = <ThrowOnError extends boolean = false>(options: Options<UpdateSessionWorkingDirData, ThrowOnError>) => (options.client ?? client).put<UpdateSessionWorkingDirResponses, UpdateSessionWorkingDirErrors, ThrowOnError>({
