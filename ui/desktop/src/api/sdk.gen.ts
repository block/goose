...
export const readThemeCss = <ThrowOnError extends boolean = false>(options?: Options<ReadThemeCssData, ThrowOnError>) => (options?.client ?? client).get<ReadThemeCssResponses, ReadThemeCssErrors, ThrowOnError>({ url: '/theme.css', ...options });
