...
export const replyHandler = <ThrowOnError extends boolean = false>(options: Options<ReplyHandlerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ReplyHandlerResponses, ReplyHandlerErrors, ThrowOnError>({
        url: '/reply',
        ...options,
        headers: {
            'Content-Type': 'application/json',
