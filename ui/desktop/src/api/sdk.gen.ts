...
import type { AddSubRecipesData, AddSubRecipesResponse2, ExtendPromptData, ExtendPromptResponse2, ResumeAgentData, ResumeAgentResponse, UpdateSessionConfigData, UpdateSessionConfigResponse, StartAgentData, StartAgentResponse2, GetToolsData, GetToolsResponse, UpdateAgentProviderData, UpdateRouterToolSelectorData, UpdateRouterToolSelectorResponse, ReadAllConfigData, ReadAllConfigResponse, BackupConfigData, BackupConfigResponse, CreateCustomProviderData, CreateCustomProviderResponse, RemoveCustomProviderData, RemoveCustomProviderResponse, GetExtensionsData, GetExtensionsResponse, AddExtensionData, AddExtensionResponse, RemoveExtensionData, RemoveExtensionResponse, InitConfigData, InitConfigResponse, UpsertPermissionsData, UpsertPermissionsResponse, ProvidersData, ProvidersResponse2, GetProviderModelsData, GetProviderModelsResponse, ReadConfigData, RecoverConfigData, RecoverConfigResponse, RemoveConfigData, RemoveConfigResponse, UpsertConfigData, UpsertConfigResponse, ValidateConfigData, ValidateConfigResponse, ConfirmPermissionData, ManageContextData, ManageContextResponse, StartOpenrouterSetupData, StartOpenrouterSetupResponse, StartTetrateSetupData, StartTetrateSetupResponse, CreateRecipeData, CreateRecipeResponse2, DecodeRecipeData, DecodeRecipeResponse2, DeleteRecipeData, DeleteRecipeResponse, EncodeRecipeData, EncodeRecipeResponse2, ListRecipesData, ListRecipesResponse, ScanRecipeData, ScanRecipeResponse2, CreateScheduleData, CreateScheduleResponse, DeleteScheduleData, DeleteScheduleResponse, ListSchedulesData, ListSchedulesResponse2, UpdateScheduleData, UpdateScheduleResponse, InspectRunningJobData, InspectRunningJobResponse, KillRunningJobData, PauseScheduleData, PauseScheduleResponse, RunNowHandlerData, RunNowHandlerResponse, SessionsHandlerData, SessionsHandlerResponse, UnpauseScheduleData, UnpauseScheduleResponse, ListSessionsData, ListSessionsResponse, GetSessionHistoryData, GetSessionHistoryResponse, StatusData, StatusResponse } from './types.gen';
...
export const resumeAgent = <ThrowOnError extends boolean = false>(options: Options<ResumeAgentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ResumeAgentResponse, unknown, ThrowOnError>({
        url: '/agent/resume',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const startAgent = <ThrowOnError extends boolean = false>(options: Options<StartAgentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<StartAgentResponse2, unknown, ThrowOnError>({
        url: '/agent/start',
        ...options,
        headers: {
            'Content-Type': 'application/json',
