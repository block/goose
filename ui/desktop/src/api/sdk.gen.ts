...
export const getAutoCompactThreshold = <ThrowOnError extends boolean = false>(options?: Options<GetAutoCompactThresholdData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAutoCompactThresholdResponses, unknown, ThrowOnError>({
...
export const getCurrentModel = <ThrowOnError extends boolean = false>(options?: Options<GetCurrentModelData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetCurrentModelResponses, unknown, ThrowOnError>({
