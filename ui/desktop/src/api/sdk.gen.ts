...
export const downloadLocalModel = <ThrowOnError extends boolean = false>(options: Options<DownloadLocalModelData, ThrowOnError>) => (options.client ?? client).post<DownloadLocalModelResponses, DownloadLocalModelErrors, ThrowOnError>({ url: '/local-inference/models/{model_id}/download', ...options });
...
export const getRepoFiles = <ThrowOnError extends boolean = false>(options: Options<GetRepoFilesData, ThrowOnError>) => (options.client ?? client).get<GetRepoFilesResponses, GetRepoFilesErrors, ThrowOnError>({ url: '/local-inference/repo/{author}/{repo}/files', ...options });
