...
export const handleSamplingApproval = <ThrowOnError extends boolean = false>(options: Options<HandleSamplingApprovalData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<HandleSamplingApprovalResponses, HandleSamplingApprovalErrors, ThrowOnError>({
