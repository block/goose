...
export const detectCloudProvider = <ThrowOnError extends boolean = false>(options: Options<DetectCloudProviderData, ThrowOnError>) => (options.client ?? client).post<DetectCloudProviderResponses, DetectCloudProviderErrors, ThrowOnError>({
...
export const confirmPermission = <ThrowOnError extends boolean = false>(options: Options<ConfirmPermissionData, ThrowOnError>) => (options.client ?? client).post<ConfirmPermissionResponses, ConfirmPermissionErrors, ThrowOnError>({
    url: '/confirm',
    ...options,
    headers: {
        'Content-Type': 'application/json',
