...
export const deleteApp = <ThrowOnError extends boolean = false>(options: Options<DeleteAppData, ThrowOnError>) => (options.client ?? client).delete<DeleteAppResponses, DeleteAppErrors, ThrowOnError>({ url: '/apps/app/{name}', ...options });

export const getApp = <ThrowOnError extends boolean = false>(options: Options<GetAppData, ThrowOnError>) => (options.client ?? client).get<GetAppResponses, GetAppErrors, ThrowOnError>({ url: '/apps/app/{name}', ...options });

export const storeApp = <ThrowOnError extends boolean = false>(options: Options<StoreAppData, ThrowOnError>) => (options.client ?? client).put<StoreAppResponses, StoreAppErrors, ThrowOnError>({
    url: '/apps/app/{name}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const exportApp = <ThrowOnError extends boolean = false>(options: Options<ExportAppData, ThrowOnError>) => (options.client ?? client).get<ExportAppResponses, ExportAppErrors, ThrowOnError>({ url: '/apps/export/{name}', ...options });
...
export const iterateApp = <ThrowOnError extends boolean = false>(options: Options<IterateAppData, ThrowOnError>) => (options.client ?? client).post<IterateAppResponses, IterateAppErrors, ThrowOnError>({
    url: '/apps/iterate',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const listApps = <ThrowOnError extends boolean = false>(options?: Options<ListAppsData, ThrowOnError>) => (options?.client ?? client).get<ListAppsResponses, ListAppsErrors, ThrowOnError>({ url: '/apps/list_apps', ...options });
