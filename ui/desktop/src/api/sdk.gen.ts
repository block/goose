...
export const readConfig = <ThrowOnError extends boolean = false>(options?: Options<ReadConfigData, ThrowOnError>) => (options?.client ?? client).get<ReadConfigResponses, unknown, ThrowOnError>({ url: '/config', ...options });
