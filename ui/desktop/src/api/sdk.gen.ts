...
export const updateCurrentProject = <ThrowOnError extends boolean = false>(options: Options<UpdateCurrentProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UpdateCurrentProjectResponses, UpdateCurrentProjectErrors, ThrowOnError>({
        url: '/projects',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const removeProject = <ThrowOnError extends boolean = false>(options: Options<RemoveProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<RemoveProjectResponses, RemoveProjectErrors, ThrowOnError>({
        url: '/projects/{path}',
        ...options
    });
};
