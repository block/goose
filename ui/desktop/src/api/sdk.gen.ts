...
export const preloadModel = <ThrowOnError extends boolean = false>(options: Options<PreloadModelData, ThrowOnError>) => (options.client ?? client).post<PreloadModelResponses, PreloadModelErrors, ThrowOnError>({
