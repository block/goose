...
export const clawReply = <ThrowOnError extends boolean = false>(options: Options<ClawReplyData, ThrowOnError>) => (options.client ?? client).post<ClawReplyResponses, ClawReplyErrors, ThrowOnError>({
    url: '/claw/reply',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const clawSession = <ThrowOnError extends boolean = false>(options?: Options<ClawSessionData, ThrowOnError>) => (options?.client ?? client).post<ClawSessionResponses, ClawSessionErrors, ThrowOnError>({ url: '/claw/session', ...options });
