...
export const resetAllPrompts = <ThrowOnError extends boolean = false>(options?: Options<ResetAllPromptsData, ThrowOnError>) => (options?.client ?? client).delete<ResetAllPromptsResponses, ResetAllPromptsErrors, ThrowOnError>({ url: '/config/prompts', ...options });
