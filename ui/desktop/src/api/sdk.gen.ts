...
export const detectApiKeys = <ThrowOnError extends boolean = false>(options?: Options<DetectApiKeysData, ThrowOnError>) => {
    return (options?.client ?? client).get<DetectApiKeysResponses, unknown, ThrowOnError>({
