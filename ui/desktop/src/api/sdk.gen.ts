...
export const listApps = <ThrowOnError extends boolean = false>(options?: Options<ListAppsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListAppsResponses, ListAppsErrors, ThrowOnError>({
        url: '/apps/list_apps',
        ...options
    });
};
...
export const deleteApp = <ThrowOnError extends boolean = false>(options: Options<DeleteAppData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteAppResponses, DeleteAppErrors, ThrowOnError>({
        url: '/apps/{name}',
        ...options
    });
};
...
export const getApp = <ThrowOnError extends boolean = false>(options: Options<GetAppData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAppResponses, GetAppErrors, ThrowOnError>({
        url: '/apps/{name}',
        ...options
    });
};
...
export const updateApp = <ThrowOnError extends boolean = false>(options: Options<UpdateAppData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateAppResponses, UpdateAppErrors, ThrowOnError>({
        url: '/apps/{name}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
