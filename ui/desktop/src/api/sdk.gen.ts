...
export const getGraphInsights = <ThrowOnError extends boolean = false>(options?: Options<GetGraphInsightsData, ThrowOnError>) => (options?.client ?? client).get<GetGraphInsightsResponses, GetGraphInsightsErrors, ThrowOnError>({ url: '/sessions/insights/graph', ...options });
