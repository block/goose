...
export const GOOSE_EXT_METHODS = [
  ...
  {
    method: "_goose/unstable/resources/subscribe",
    requestType: "SubscribeResourceRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
    method: "_goose/unstable/resources/unsubscribe",
    requestType: "UnsubscribeResourceRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
...
export const GOOSE_EXT_NOTIFICATIONS = [
  ...
  {
    method: "_goose/unstable/resources/updated",
    paramsType: "ResourceUpdatedNotification_unstable",
  },
  {
    method: "_goose/unstable/resources/list_changed",
    paramsType: "ResourceListChangedNotification_unstable",
  },
] as const;
