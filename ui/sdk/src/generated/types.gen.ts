 ...
 */
export type ProviderModelCapabilitiesRequest_unstable = {
    providerId: string;
    modelId: string;
};

export type ProviderModelCapabilitiesResponse_unstable = {
    /**
