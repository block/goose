 ...
 */
export type AuthenticateConfigExtensionRequest_unstable = {
    configKey: string;
    force?: boolean;
};
 ...
 */
export type DeauthenticateConfigExtensionRequest_unstable = {
    configKey: string;
};
 ...
 */
export type ExtensionAuthorizationRequiredNotification_unstable = {
    extensionName: string;
...
export type ExtNotification = {
    method: string;
    params?: GooseSessionNotification_unstable | ExtensionAuthorizationRequiredNotification_unstable | {
        [key: string]: unknown;
    } | null;
};
