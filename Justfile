...
test-buzz:
    ...
    for file in buzz/create_github_manager buzz/create_issue_channel buzz/list_issue_work buzz/list_pull_request_work buzz/manage_issue_lifecycle buzz/syncissues buzz/github_manager.mjs; do node --check "$file"; done
