...
1. Go to https://github.com/bfg-ent/goose and click “Fork” (top-right corner).
...
```
git remote add upstream https://github.com/bfg-ent/goose.git
```
...
8. Open a Pull Request from your branch on your fork to bfg-ent/goose’s main branch.
...
[issues]: https://github.com/bfg-ent/goose/issues
...
- **Give Feedback:** Have a feature you want to see or encounter an issue with goose, [click here to open an issue](https://github.com/bfg-ent/goose/issues/new/choose), [start a discussion](https://github.com/bfg-ent/goose/discussions) or tell us on Discord.
